...
class WatersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create water" do
    assert_difference('Water.count') do
      post waters_url, params: { water: { first_water: @water.first_water, water: @water.water } }
    end
  ...
  test "should update water" do
    patch water_url(@water), params: { water: { first_water: @water.first_water, water: @water.water } }
